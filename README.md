...
![หกสถานการณ์ แต่ละอันมี system prompt ของตัวเอง](./docs/images/conversation-roles.jpg)
...
![ภาพรวมสามชั้น: Client · Backend · AI Services](./docs/images/architecture-overview.jpg)

*ภาพรวมสามชั้นของแอป ภาพนี้เป็นดีไซน์รอบแรกที่ทุกอย่างวิ่งผ่าน Gemini ปัจจุบันฝั่งแชตย้ายไป ThaiLLM แล้ว (ดูย่อหน้าถัดไป) ส่วน Firebase, TTS และ AsyncStorage ยังเหมือนเดิม*

![UML use case: Auth · AI Chat · Game Module · Gamification · TTS](./docs/images/usecase-diagram.jpg)
...
![ลำดับงาน LLM ทั้ง 7 ขั้น ตั้งแต่เลือกฉากจนถึงอ่านออกเสียง](./docs/images/llm-workflow.jpg)

### ความหน่วงที่ทำให้แอปดู "ค้าง"

บนมือถือ คำตอบที่ใช้เวลา 1.5–2 วินาทีไม่ได้รู้สึกว่า "ช้า" แต่รู้สึกว่า "พัง" ผู้ใช้กดซ้ำหรือออกจากหน้าไปก่อนคำตอบมา
วิธีแก้คือ stream โทเค็นทันทีที่โมเดลเริ่มตอบ คำแรกโผล่ภายในราว 300 ms แล้วที่เหลือค่อยไหลตามมา พร้อม typing indicator
เวลาจริงที่โมเดลใช้เท่าเดิม แต่เวลาที่ผู้ใช้ *รู้สึก* ว่ารอลดลงมาก และเป็นบทเรียนที่ติดตัวไปใช้กับงาน RAG ทุกตัวหลังจากนี้

![ก่อน/หลัง streaming: first token 1,800 ms → ~300 ms](./docs/images/latency-streaming.jpg)
